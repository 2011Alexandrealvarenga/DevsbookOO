    ...
    <div class="box-body">
        <div class="feed-new-editor m-10 row">
            ...
            <div class="feed-new-photo">
                ...
                <input type="file" name="photo" class="feed-new-file" accept="image/png, imge/jpeg, image/jpg" />
            </div>
            <div class="feed-new-send">
                <img src="<?=$base;?>/assets/images/send.png" />
            </div>
            <form class="feed-new-form" method="post" action="<?=$base;?>/feed_editr_action.php">
